...
ordre_ARIMA(histoMod_2, dateDebMod, dateFinMod)
test = previsions_ARIMA (histoMod_2, dateDebMod, dateFinMod, hPrev, 5, 1, 5)
print(test)
...
plt.fill_between(test['Date'],
                test['IC95.0_up_ARIMA'],
                test['IC95.0_low_ARIMA'], color='k', alpha=.2, label = 'Intervalle de confiance')
ax.set_xlabel('Date')
ax.set_ylabel('PAX')
plt.legend()
plt.show()
